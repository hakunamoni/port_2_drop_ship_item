...
function getCustomerLogo(logofileid){
	try {
		...
		nlapiLogExecution('debug', 'Event', 'An error occurred when trying to load the file.');
		return null;
	}
	return null;
}
...
function afterSubmit(type) {
	...
	if (type != "create"){
		if (type === 'edit')
		{
			var csinid = nlapiLookupField("purchaseorder", nlapiGetRecordId(), "custbody_po_cssoinid");
	...
	//if(type != 'dropship') { return null; }
	//TODO: check if line type is CS
	var productline = "CS";

	if(productline !== "CS") return null;

	nlapiLogExecution('Debug','AfterSubmit Is Started : ', "Purchase Order Is Created.");
	...
	if (createdFrom)
	{
		...
		try{
			...
			if (!csso.logo ){
				nlapiLogExecution('debug','Do not Sending PO info to CS because Logo is NuLL');
				return null;
			}
...
function sendSOtoCS(soinfo){
	try{
		...
		var token = {
			key: 'f9330901240a215c137ede20b210d39e663a3ab25d623ad308c5a3ebbc25e19c',
			secret: '803e428958980e96d559e0fbc5c04e12ae8bf86228a6d2de230be77b166519eb'
		};

		var oauth = OAuth({
			consumer: {
				key: '8d8591f6f2522235dc1296fe415c2393d08ead17ca86ee8583f499a1ad933610',
				secret: '623f36c327dd2ce8c9c67f47abe6b2b37e2e5f0aaa9b2d819d08a4e18b903951'
			},
